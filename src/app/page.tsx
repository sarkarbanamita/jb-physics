...
export default function HomePage() {
  const chapters = [
    ...
    },
    {
      ...
      descriptionEn: 'Drift velocity, Ohm law, circuit rules, meter conversions & resistance.',
      descriptionBn: 'বিচলন বেগ, ওহমের সূত্র, কার্শফের নিয়মাবলী ও পরিমাপক মিটার।',
      simType: null,
    },
    {
      titleEn: 'Unit 3: Magnetic Effects',
      titleBn: 'অধ্যায় ৩: তড়িৎপ্রবাহের চৌম্বক ক্রিয়া',
      slug: 'magnetism',
      icon: Compass,
